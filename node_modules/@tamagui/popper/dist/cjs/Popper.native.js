...
function Popper(props) {
  var _middlewareData_checkFloating, { children, size, strategy = "absolute", placement = "bottom", stayInFrame, allowFlip, offset, disableRTL, resize, __scopePopper } = props, [arrowEl, setArrow] = React.useState(null), [arrowSize, setArrowSize] = React.useState(0), offsetOptions = offset ?? arrowSize, floatingStyle = React.useRef({}), floating = (0, import_floating.useFloating)({
    strategy,
    placement,
    sameScrollView: !1,
...
var PopperAnchor = import_stacks.YStack.extractable(/* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  var { __scopePopper, enableAnimationForPositionChange, ...rest } = props, { strategy, placement, refs, x, y, getFloatingProps, size } = usePopperContext(__scopePopper), contentRefs = (0, import_compose_refs.useComposedRefs)(refs.setFloating, forwardedRef), [needsMeasure, setNeedsMeasure] = React.useState(enableAnimationForPositionChange);
  (0, import_constants.useIsomorphicLayoutEffect)(function() {
