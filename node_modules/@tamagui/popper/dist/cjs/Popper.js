...
const PopperAnchor = import_stacks.YStack.extractable(
  ...
  const { __scopePopper, enableAnimationForPositionChange, ...rest } = props, { strategy, placement, refs, x, y, getFloatingProps, size } = usePopperContext(__scopePopper), contentRefs = (0, import_compose_refs.useComposedRefs)(refs.setFloating, forwardedRef), [needsMeasure, setNeedsMeasure] = React.useState(enableAnimationForPositionChange);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core.Stack, { ...floatingProps, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    PopperContentFrame,
    {
