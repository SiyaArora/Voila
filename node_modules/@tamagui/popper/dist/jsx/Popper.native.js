...
function Popper(props) {
  var _middlewareData_checkFloating, { children, size, strategy = "absolute", placement = "bottom", stayInFrame, allowFlip, offset, disableRTL, resize, __scopePopper } = props, [arrowEl, setArrow] = React.useState(null), [arrowSize, setArrowSize] = React.useState(0), offsetOptions = offset ?? arrowSize, floatingStyle = React.useRef({}), floating = useFloating({
    strategy,
    placement,
    sameScrollView: !1,
...
var PopperAnchor = YStack.extractable(/* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  var { __scopePopper, enableAnimationForPositionChange, ...rest } = props, { strategy, placement, refs, x, y, getFloatingProps, size } = usePopperContext(__scopePopper), contentRefs = useComposedRefs(refs.setFloating, forwardedRef), [needsMeasure, setNeedsMeasure] = React.useState(enableAnimationForPositionChange);
  useIsomorphicLayoutEffect(function() {
