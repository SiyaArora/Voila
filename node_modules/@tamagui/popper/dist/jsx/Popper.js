...
function Popper(props) {
  ...
  const { middlewareData } = floating, popperContext = {
    size,
    arrowRef: setArrow,
...
const PopperAnchor = YStack.extractable(
  ...
  const { __scopePopper, enableAnimationForPositionChange, ...rest } = props, { strategy, placement, refs, x, y, getFloatingProps, size } = usePopperContext(__scopePopper), contentRefs = useComposedRefs(refs.setFloating, forwardedRef), [needsMeasure, setNeedsMeasure] = React.useState(enableAnimationForPositionChange);
  ...
  return /* @__PURE__ */ jsx(Stack, { ...floatingProps, children: /* @__PURE__ */ jsx(
    PopperContentFrame,
    {
