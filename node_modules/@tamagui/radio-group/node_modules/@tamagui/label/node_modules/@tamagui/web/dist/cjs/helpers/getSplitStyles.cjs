...
function addStyleToInsertRules(rulesToInsert, styleObject, startedUnhydrated = !1) {
  {
    ...
    !startedUnhydrated || !import_constants.IS_REACT_19 ? (0, import_insertStyleRule.shouldInsertStyleRules)(identifier) && ((0, import_insertStyleRule.updateRules)(identifier, styleObject[import_helpers.StyleObjectRules]), rulesToInsert[identifier] = styleObject) : rulesToInsert[identifier] = styleObject;
  }
}
